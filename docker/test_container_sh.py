...
def _write_start_stub(tmp_path):
    ...
    docker_stub.write_text(
        ...
        "case \" $* \" in\n"
        "  *' config --format json '*)\n"
        "    printf '%s\\n' '{\"services\":{\"lerobot\":{\"image\":\"robotis/lerobot-zenoh:1.3.2-arm64\"},\"vitacformer\":{\"image\":\"robotis/vitacformer-zenoh:1.0.0-arm64\"},\"groot\":{\"image\":\"robotis/groot-zenoh:1.3.4-arm64\"}}}'\n"
        "    ;;\n"
        "esac\n"
