...
class ActionChunkProcessorTests(unittest.TestCase):
    ...
    def test_legacy_positional_alignment_mode_keeps_a_order(self) -> None:
        processor = ActionChunkProcessor(15.0, 100.0, 0.3, True, None, "none")

        self.assertEqual(processor._alignment_mode, "none")
        self.assertIsNone(processor._source_chunk_limit)

    def test_transient_b_positional_source_limit_is_still_accepted(self) -> None:
        processor = ActionChunkProcessor(15.0, 100.0, 0.3, True, None, 3, "none")

        self.assertEqual(processor._alignment_mode, "none")
        self.assertEqual(processor._source_chunk_limit, 3)
